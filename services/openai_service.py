...
- إذا سأل الطالب عن قائمة (تخصصات، كليات، برامج، متطلبات، إلخ) يجب ذكر القائمة كاملة
- لا تقل "وغيرها" أو "والمزيد" أو "مثل" ثم تذكر 2-3 فقط
- اذكر كل عنصر في القائمة بالاسم الكامل
- مثال: إذا سأل عن التخصصات، اذكر كل تخصص متاح، لا تختصر أبداً
...
🚫 ممنوع:
- لا تذكر أي تفاصيل تقنية (Redis، caching، embeddings)
...
- قدم معلومات كاملة وشاملة

قم بإنشاء إجابة شاملة ومفصلة تغطي جميع جوانب السؤال بدون أي اختصار."""
...
قواعد صارمة:
1. كن شاملاً ومفصلاً في إجاباتك - لا تكن مختصراً أبداً
2. إذا سأل عن قائمة (تخصصات، كليات، برامج) اذكر القائمة كاملة - لا تقل "وغيرها" أو "مثل"
3. استخدم تنظيم واضح مع عناوين فرعية (##) ونقاط (-) وقوائم مرقمة
4. قدم أمثلة وتوضيحات عملية
5. كن ودوداً ومهتماً بمساعدة الطلاب
6. لا تختصر أي معلومات - قدم كل التفاصيل المتاحة"""
                    },
                    {
                        "role": "user",
                        "content": prompt
                ...
                temperature=0.7,
                max_tokens=3000  # Increased for longer, more complete answers
            )
